...
/**
 * This is the extension manager of the Ctcaddon extension.
 */
public class CtcaddonManager extends GeneratedCtcaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CtcaddonManager.class.getName());
	 ...
	 */
	public static CtcaddonManager getInstance()
	{
		return (CtcaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CtcaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CtcaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CtcaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CtcaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CtcaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
