 ...
 */
package com.ctc.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(CtcFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CtcFulfilmentProcessConstants.PARENT_PROCESS);
