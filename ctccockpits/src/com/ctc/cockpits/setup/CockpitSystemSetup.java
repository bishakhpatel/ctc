 ...
 */
package com.ctc.cockpits.setup;
...
import com.ctc.cockpits.constants.CtcCockpitsConstants;
 ...
 */
@SystemSetup(extension = CtcCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(CtcCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(CtcCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						CtcCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/ctccockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
