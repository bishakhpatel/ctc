...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ctcstorefront/electronics/en",
						"https://electronics.local:9002/ctcstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ctcstorefront/electronics/en",
						"https://electronics.local:9002/ctcstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ctcstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ctcstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ctcstorefront/electronics/en",
						"https://electronics.local:9002/ctcstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ctcstorefront",
						"https://electronics.local:9002/ctcstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ctcstorefront",
						"https://electronics.local:9002/ctcstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ctcstorefront/electronics/en",
						"https://electronics.local:9002/ctcstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
