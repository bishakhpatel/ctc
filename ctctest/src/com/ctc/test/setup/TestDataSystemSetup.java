...
import com.ctc.test.constants.CtcTestConstants;
import com.ctc.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CtcTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ctctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ctctest/import/reviews.impex");
			...
			importImpexFile(context, "/ctctest/import/cstickets.impex");
		}
	}
}
