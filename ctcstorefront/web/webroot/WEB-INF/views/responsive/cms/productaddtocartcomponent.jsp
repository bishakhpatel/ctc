...
<div class="addtocart-component">
		...
		<div class="qty-selector input-group js-qty-selector">
			<%-- <span class="input-group-btn">
				...
				<input type="text" maxlength="3" disabled class="form-control js-qty-selector-input" size="1" value="${qtyMinus}" data-max="${maxQty}" data-min="1" name="pdpAddtoCartInput"  id="pdpAddtoCartInput" />
			<!-- <span class="input-group-btn">
