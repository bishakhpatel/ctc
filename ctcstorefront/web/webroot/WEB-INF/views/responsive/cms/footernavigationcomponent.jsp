	        ...
	        <div class="row">
	           ...
	           <div class="footer__right col-xs-12 col-md-5">
	               <nav class="menu menu_social col-md-10">
                                        <span class="menu_social__header hidden-xs hidden-sm">CONNECT WITH WOODS CANADA</span>
                                        <ul class="nav menu">
                                        
<li class="item-10854"><a href="https://www.facebook.com/WoodsCanada" target="_blank"><img src="${themeResourcePath}/images/facebook.png" alt="Facebook Page"></a></li>
